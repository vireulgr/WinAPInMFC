...
// FileSystem1_MFC1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFileSystem1_MFC1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CFileSystem1_MFC1App

CFileSystem1_MFC1App::CFileSystem1_MFC1App()
{
...
// Единственный объект CFileSystem1_MFC1App

CFileSystem1_MFC1App theApp;


// инициализация CFileSystem1_MFC1App

BOOL CFileSystem1_MFC1App::InitInstance()
{
